export const aboutData = {
    meaningBali: "BӑLì significa potencia en Chino.  Y representa los componentes y la tecnologia de mejor calidad en una bicicleta 100% china",
    typeProject: "Es un proyecto accesible y sin intermediarios hecho a la medida del ciclista",
    ricePods: "Las vainas de arroz representan la energía para lograr, con la mejor tecnología, ese resultado en cada reto o competencia",
    ...
    timeResponse: {
       ...
       data: [
        "La bicicleta se entrega en un plazo menor a los 90 dias desde el pedido y anticipo del 50%",
        "El plazo contempla la fabricación a mano, compra de componentes, Pintado, prearmado en China, Armado y configuración en Mexico previo a la entrega",
        "El equipo de Bali te acompaña en todo el proceso desde la primera conversación, hasta la primera rodada y ante cualquier incidente postventa"
       ]
    },
    note: "Nota: Una bicicleta con un prefit no sustituye el trabajo de un fit profesional pero asegura reducir las modificaciones al minimo"
